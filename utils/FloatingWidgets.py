...
# Option Buttons
class O_Floating_Button(QPushButton):
    ...
    # Top Left
    def O_update_position_Buttons(self, index):
...
# Diver Status
class D_Floating_Widget(StatusLabel): 
    def __init__(self, parent=None):
        super().__init__(parent)
        self.paddingTop = 30

    # Top Center
    def D_update_position_Widgets(self):
...
# Compass
class C_Floating_Widget(CompassDisplay): 
    def __init__(self, parent=None):
        super().__init__(parent)
        self.paddingTop = 30
        self.paddingRight = 30
    ...
    # Top Right
    def C_update_position_Widgets(self):
        parent_width = self.parent().width()
...
# SLAM Buttons
class S_Floating_Button(QPushButton):
    def __init__(self, parent, text=""):
        super().__init__(text, parent)
        self.paddingTop = 30
